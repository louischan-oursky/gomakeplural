...
// at Fri, 12 Apr 2019 21:55:39 +0800
//
...
func init() {
    ...
    plural_funcs["ars"] = func(value interface{}, ordinal bool) string {
		n := math.Abs(float(value))
		n100 := mod(n, 100)
		p := float64(int64(n)) == n
    ...
    plural_funcs["ceb"] = func(value interface{}, ordinal bool) string {
		f, i, _, v, _, _ := finvtw(value)
		i10 := i % 10
		f10 := f % 10
    ...
    plural_funcs["ia"] = func(value interface{}, ordinal bool) string {
		_, i, _, v, _, _ := finvtw(value)
    ...
    plural_funcs["io"] = func(value interface{}, ordinal bool) string {
		_, i, _, v, _, _ := finvtw(value)
    ...
    plural_funcs["sc"] = func(value interface{}, ordinal bool) string {
		_, i, n, v, _, _ := finvtw(value)
    ...
    plural_funcs["scn"] = func(value interface{}, ordinal bool) string {
		_, i, n, v, _, _ := finvtw(value)
    ...
    plural_funcs["sd"] = func(value interface{}, ordinal bool) string {
		n := math.Abs(float(value))
    ...
    plural_funcs["sdh"] = func(value interface{}, ordinal bool) string {
		n := math.Abs(float(value))
    ...
    plural_funcs["yue"] = func(value interface{}, ordinal bool) string {
		if ordinal {
			return "other"
		}
